...
# prepare data
data_files = {'train': 'data/cnndm_slo/train.jsonl',
              'test': 'data/cnndm_slo/test.jsonl',
              'val': 'data/cnndm_slo/val.jsonl'}
data = load_dataset('json', data_files=data_files)
tokenized_data = data.map(preprocess_function_cnndm, batched=True)
